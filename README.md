...
- echte Lektionsübersicht mit Lernzielen, Inhaltsvorschau, Zeitbedarf und Start-/Fortsetzen-Button
- geführter Lesson Player statt einer Sammlung kurzer Expander
- pro Lektion mindestens zehn ausführliche, aufeinander aufbauende Theoriekapitel
- rund 2.400 bis 2.550 Wörter Theorie pro Standardlektion; rund 3.900 Wörter in der HTTP-/API-Lektion
- ein Wissenscheck und eine aktive Ausarbeitung in jedem einzelnen Kapitel
...
Die Lernphasen sind absichtlich miteinander verbunden und werden schrittweise freigeschaltet: Kapitelwissen und aktive Ausarbeitung → Kapitelcheck → Abschlussquiz → Debug Lab → Build Mission. Jede Quizfrage verweist auf ein konkretes Learn-Kapitel; Debug Lab und Build Mission greifen dessen Begriffe, Abläufe und Failure Modes erneut auf. Eine Lektion ist damit kein Nebeneinander unabhängiger Tabs, sondern eine Lernkette von Theorie über Abruf und Diagnose bis zum Transfer.
